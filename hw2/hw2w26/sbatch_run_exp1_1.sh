...
# SBATCH wrapper to run all Experiment 1.1 configurations sequentially
# Usage: sbatch sbatch_run_exp1_1.sh
...
# Run configs: K in {32,64}, L in {2,4,8,16}
for K in 32 64; do
...
echo "Created sbatch_run_exp1_1.sh. Submit with: sbatch sbatch_run_exp1_1.sh"}```}035